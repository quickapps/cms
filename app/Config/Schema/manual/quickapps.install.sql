...
--
-- Table structure for table `#__nodes_terms`
--

DROP TABLE IF EXISTS `#__nodes_terms`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `#__nodes_terms` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `#__nodes_terms`
--
...
LOCK TABLES `#__translations` WRITE;
/*!40000 ALTER TABLE `#__translations` DISABLE KEYS */;
INSERT INTO `#__translations` VALUES (1,'Open Source CMS built on CakePHP 2.0',1319980605,1,1319980612,1);
...
INSERT INTO `#__users` VALUES (1,'admin','QuickApps','f6ab52454037ee501824bf30e2fb0544edb36c77','info@quickapps.es',0,'','','','4e46f0b7-bb50-4587-9217-14bc22b50a39',1,1313271991,1319724104,1319724104);
...
--
-- Dumping data for table `#__users_roles`
--

LOCK TABLES `#__users_roles` WRITE;
/*!40000 ALTER TABLE `#__users_roles` DISABLE KEYS */;
INSERT INTO `#__users_roles` VALUES (8,1,1);
/*!40000 ALTER TABLE `#__users_roles` ENABLE KEYS */;
UNLOCK TABLES;
