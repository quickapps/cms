...
class Field extends FieldAppModel {
    ...
    public function beforeValidate() {
        ...
        $before = $this->hook(Inflector::underscore($this->data['Field']['field_module']) . "_beforeValidateInstance", $this);
    ...
    public function beforeSave() {
        if (isset($this->data['Field']['field_module'])) {
            ...
            $before = $this->hook(Inflector::underscore($this->data['Field']['field_module']) . "_beforeSaveInstance", $this);
    ...
    public function afterSave() {
        ...
        $this->hook(Inflector::underscore($field['Field']['field_module']) . "_afterSaveInstance", $this);
    }

    public function beforeDelete() {
        $this->data = $this->read(); # tmp holder (before/afterDelete)
        $before = $this->hook(Inflector::underscore($this->field['Field']['field_module']) . "_beforeDeleteInstance", $this, array('collectReturn' => false));
    ...
    public function move($id, $dir = 'up', $view_mode = false) {
        ...
        $this->hook(Inflector::underscore($record['Field']['field_module']) . "_beforeMoveInstance", $_data);
        extract($_data);
        ...
        $this->hook(Inflector::underscore($record['Field']['field_module']) . "_afterMoveInstance", $_data);
    ...
    public function setViewModes($modes, $conditions = false) {
        ...
        foreach ($fields as &$field) {
            $this->hook(Inflector::underscore($field['Field']['field_module']) . "_beforeSetViewModes", $field);
            ...
            $this->hook(Inflector::underscore($field['Field']['field_module']) . "_afterSetViewModes", $field);
        }
    }
}