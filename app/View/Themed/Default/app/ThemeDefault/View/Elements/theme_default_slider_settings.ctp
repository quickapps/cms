...
<em><?php echo __d('theme_default', 'Enter one image per line, in the format <b>file name|url|caption</b>. e.g.:'); ?></em>
<p>
...
<em> - <?php echo __d('theme_default', 'Image files should be stoted in /files/<b>%s</b>, you can change this folder in the <a href="%s">theme settings panel</a>', Configure::read('Modules.ThemeDefault.settings.slider_folder'), $this->Html->url('/admin/system/themes/settings/Default')); ?></em><br/>
<em> - <?php echo __d('theme_default', 'Special tags are allowed'); ?></em>