...
<em> - <?php echo __t('Image files should be stoted in /files/<b>%s</b>, you can change this folder in the <a href="%s">theme settings panel</a>', Configure::read('Modules.ThemeDefault.settings.slider_folder'), $this->Html->url('/admin/system/themes/settings/Default')); ?></em><br/>
