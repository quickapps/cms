...
('Locale', 'quickapps-plugin/locale', '', 1, 6),
('Menu', 'quickapps-plugin/menu', '', 1, 7),
('Node', 'quickapps-plugin/node', '', 1, 8),
('Search', 'quickapps-plugin/search', '', 1, 9),
('System', 'quickapps-plugin/system', '', 1, 10),
('Taxonomy', 'quickapps-plugin/taxonomy', '', 1, 11),
...
('Wysiwyg', 'quickapps-plugin/wysiwyg', '', 1, 13);
