...
<div class="row">
    <div class="col-md-12">
        <?php echo $this->Form->create($link); ?>
            <fieldset>
                <legend><?php echo __d('menu', "Add New Menu's Link"); ?></legend>
                ...
                <em class="help-block"><?php echo __d('menu', 'The path for this menu link. This can be an internal QuickApps CMS path such as "/article/my-first-article{0}" or an external URL such as http://quickappscms.org. Enter "/" to link to the front page. You can easily link to an existing content using the "Link to content" option above.', CONTENT_EXTENSION); ?></em>
            ...
            <?php echo $this->Form->submit(__d('menu', '&laquo; Save & go back to links tree'), ['name' => 'action_menu', 'escape' => false]); ?>
            <?php echo $this->Form->submit(__d('menu', 'Save & add another &raquo;'), ['name' => 'action_add', 'escape' => false]); ?>
