...
<p>
    ...
    the <?= $this->Html->link('Blocks administration page', ['plugin' => 'Block', 'controller' => 'manage', 'prefix' => 'admin']); ?>.
    You can view and manage menus on the <?= $this->Html->link('Menus administration page', ['plugin' => 'Menu', 'controller' => 'manage', 'prefix' => 'admin']); ?>.
</p>
...
<dl>
    ...
    <dd>
        Users with the proper permissions can add, edit and delete custom menus on the <?= $this->Html->link('Menus administration page', ['plugin' => 'Menu', 'controller' => 'manage', 'prefix' => 'admin']); ?>.
    ...
    <dd>
        ...
        <?= $this->Html->link('Blocks administration page', ['plugin' => 'Block', 'controller' => 'manage', 'prefix' => 'admin']); ?>.
    </dd>
</dl>