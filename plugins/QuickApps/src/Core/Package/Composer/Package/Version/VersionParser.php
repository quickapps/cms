...
namespace QuickApps\Core\Package\Composer\Package\Version;

use QuickApps\Core\Package\Composer\Package\BasePackage;
use QuickApps\Core\Package\Composer\Package\Link;
use QuickApps\Core\Package\Composer\Package\LinkConstraint\EmptyConstraint;
use QuickApps\Core\Package\Composer\Package\LinkConstraint\MultiConstraint;
use QuickApps\Core\Package\Composer\Package\LinkConstraint\VersionConstraint;
use QuickApps\Core\Package\Composer\Package\PackageInterface;
...
class VersionParser
{
     ...
     * @param bool             $truncate Whether to truncate or not
     * @return string
     */
    public static function formatVersion(PackageInterface $package, $truncate = true)
    {
        if (!$package->isDev() || !in_array($package->getSourceType(), ['hg', 'git'])) {
     ...
     *
     * @param  string                                                   $constraints Constraints
     ...
     */
    public function manipulateVersionString($matches, $position, $increment = 0, $pad = '0')
    {
        for ($i = 4; $i > 0; $i--) {
            if ($i > $position) {
                $matches[$i] = $pad;
