...
(10, 3, 'article-body', '2', 'nodes_article', '<p>&#39;&lt;/ul&gt;&#39;</p>\r\n', 'a:0:{}');
...
INSERT INTO `menu_links` (`id`, `menu_id`, `lft`, `rght`, `parent_id`, `url`, `description`, `title`, `plugin`, `target`, `expanded`, `selected_on`, `selected_on_type`, `status`) VALUES
(1, 'management', 1, 2, 0, '/admin/system/dashboard', NULL, 'Dashboard', 'System', '_self', 0, NULL, NULL, 1),
(2, 'management', 3, 12, 0, '/admin/system/structure', NULL, 'Structure', 'System', '_self', 0, NULL, NULL, 1),
(3, 'management', 13, 14, 0, '/admin/node/manage', NULL, 'Content', 'System', '_self', 0, '/admin/node/manage*', 'reg', 1),
(4, 'management', 15, 16, 0, '/admin/system/themes', NULL, 'Appearance', 'System', '_self', 0, NULL, NULL, 1),
(5, 'management', 17, 18, 0, '/admin/system/plugins', NULL, 'Plugin', 'System', '_self', 0, NULL, NULL, 1),
(6, 'management', 19, 20, 0, '/admin/user/manage', NULL, 'Users', 'System', '_self', 0, NULL, NULL, 1),
(7, 'management', 23, 24, 0, '/admin/system/configuration', NULL, 'Configuration', 'System', '_self', 0, NULL, NULL, 1),
(8, 'management', 25, 26, 0, '/admin/system/help', NULL, 'Help', 'System', '_self', 0, '/admin/system/help*', 'reg', 1),
(9, 'management', 4, 5, 2, '/admin/block/manage', 'Configure what block content appears in your site''s sidebars and other regions.', 'Blocks', 'System', '_self', 0, NULL, NULL, 1),
(10, 'management', 6, 7, 2, '/admin/node/types', 'Manage content types.', 'Content Types', 'System', '_self', 0, NULL, NULL, 1),
(11, 'management', 8, 9, 2, '/admin/menu/manage', 'Add new menus to your site, edit existing menus, and rename and reorganize menu links.', 'Menus', 'System', '_self', 0, NULL, NULL, 1),
(12, 'management', 10, 11, 2, '/admin/taxonomy/manage', 'Manage tagging, categorization, and classification of your content.', 'Taxonomy', 'System', '_self', 0, NULL, NULL, 1),
(13, 'main-menu', 3, 4, 0, '/page/hooktags.html', '', 'Hooktags', 'Menu', '_self', 0, NULL, NULL, 1),
(17, 'main-menu', 5, 6, 0, '/page/about.html', '', 'About', 'Menu', '_self', 0, NULL, NULL, 1),
(18, 'management', 21, 22, 0, '/admin/locale', '', 'Languages', 'Locale', '_self', 0, NULL, NULL, 1),
(21, 'main-menu', 1, 2, 0, '/', '', 'Home', 'Menu', '_self', 0, NULL, NULL, 1),
(22, 'user-menu', 1, 2, 0, '/user/my_account', '', 'My account', 'Menu', '_self', 0, NULL, NULL, 1),
(23, 'user-menu', 3, 4, 0, '/user/logout', '', 'Logout', 'Menu', '_self', 0, NULL, NULL, 1),
(24, 'main-menu', 7, 8, 0, '/search/type:article', '', 'Blog', 'Menu', '_self', 0, '/article/*.html\r\n/search/type:article*', 'reg', 1),
(25, 'navigation', 1, 2, 0, 'http://www.quickappscms.org', '', 'QuickApps Site', 'Menu', '_blank', 0, '', '', 1),
(26, 'navigation', 3, 4, 0, 'https://github.com/QuickAppsCMS/QuickApps-CMS-Docs', '', 'Documentation', 'Menu', '_blank', 0, '', '', 1);
...
(1, 1, 'article', 'my-first-article', 'My First Article', 'Custom meta description', 1, 1, 1, '', 1, NULL, 8, 1, '0000-00-00 00:00:00', '2014-04-05 01:05:13', 1, 0),
(2, 1, 'article', 'my-second-article', 'My Second Article', 'Custom meta description', 1, 1, 0, '', 1, 1, 5, 2, '0000-00-00 00:00:00', '2014-04-05 04:46:43', 1, 0),
...
(2, '2', 'nodes', ' <p>&#39;&lt;/ul&gt;&#39;</p> my second article '),
(3, '3', 'nodes', ' about us '),
