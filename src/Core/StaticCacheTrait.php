 ...
 * 
 * Allows classes to optimize their methods by providing a simple `cache()`
 * static method for reading and writing values.
 */
 ...
 *   e.g.: `$key = static::cache(null, 'search key for this value')`, if no key for the given
