 ...
 *     )
 *
 * In the example above, User entity has a custom field named `user-age` and its current value is 22.
 * In the other hand, it also has a `user-phone` field but no information was given (Schema equivalent: NULL cell).
 *
