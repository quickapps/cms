...
class PluginsFixture extends TestFixture {
	...
	public $fields = [
		...
		'package' => ['type' => 'string', 'length' => 255, 'null' => false],
		'settings' => ['type' => 'string', 'null' => true],
		'status' => ['type' => 'boolean'],
		'ordering' => ['type' => 'integer', 'null' => false, 'default' => 0],
		'_constraints' => ['primary' => ['type' => 'primary', 'columns' => ['name']]],
	];
